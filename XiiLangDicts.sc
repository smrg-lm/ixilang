	...
	*getDict {arg language;
		var langs = (
			...
			\spanish : 	( 'grupo': "group", 'secuencia': "sequence", 'futuro': "future", 'foto': "snapshot", 'tempo': "tempo", 'escala': "scale",
							'empujarescala': "scalepush", 'afinación': "tuning", 'empujarafinación': "scalepush", 'recordar': "remind",
	...
	*getList {arg language;
		var langs = (
			...
			\spanish : ["grupo", "secuencia", "futuro", "foto", "->", "))", "((", "|", "[", "{", "(", ".", ">>", "<<", "tempo",
						"escala", "empujarescala", "afinación", "empujarafinación", "recordar", "tonalidad", "instr", "notaclave",
